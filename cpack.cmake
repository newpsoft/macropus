...
if (BUILD_PACKAGE)
	...
	set (CPACK_RESOURCE_FILE_LICENSE
		 "${CMAKE_CURRENT_SOURCE_DIR}/libmacro/LICENSE")
	set (CPACK_RESOURCE_FILE_README
		  "${CMAKE_CURRENT_SOURCE_DIR}/libmacro/README.md")
	...
	set (CPACK_PACKAGE_NAME "Macropus")
	set (CPACK_PACKAGE_DESCRIPTION_SUMMARY "Macropus is a Libmacro hotkey application.")
	set (CPACK_PACKAGE_INSTALL_DIRECTORY "Macropus ${MCR_VER}")

	set (CPACK_PACKAGE_INSTALL_REGISTRY_KEY "Macropus ${MCR_VER}.${GIT_REVISION}")
...
#		set (CPACK_NSIS_MODIFY_PATH ON)
        set (CPACK_NSIS_DISPLAY_NAME "Macropus")
		set (CPACK_NSIS_PACKAGE_NAME "Macropus")
